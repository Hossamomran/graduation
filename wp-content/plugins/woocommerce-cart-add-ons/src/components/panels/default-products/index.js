...
const PanelExampleProducts = ( props ) => {
	...
	return (
		<Panel className="wc-cart-addons-block-panel">
			<PanelBody
				title={ __( 'Default Products', 'sfn_cart_addons' ) }
				initialOpen={ true }
			>
				<HelpLabel
					text={ __(
					...
					<>
						{ defaultAddons.length > 0 ? (
							...
							<>
								<HelpEmpty
									text={ __(
										'You haven’t added any default products yet.',
										'sfn_cart_addons'
									) }
								/>
							</>
...
export default PanelExampleProducts;
